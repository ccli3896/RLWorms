...
# CSV
folder <- "./R01_5_4_ImportingData_Datasets/"
fname <- paste(folder,"mbb.csv",sep="")
rio_csv <- import(fname)
head(rio_csv)

# TXT
rio_txt <- import(paste(folder,"mbb.txt",sep=""))
head(rio_txt)

# Excel XLSX
rio_xlsx <- import(paste(folder,"mbb.xlsx",sep=""))
head(rio_xlsx)
